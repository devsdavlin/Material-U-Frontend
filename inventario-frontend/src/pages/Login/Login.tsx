    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          {error && (
            <p style={{ color: '#e11d48', fontSize: '0.85rem', margin: 0, fontWeight: '600' }}>
          ...
          <button
            type="submit"
            style={{
              background: '#ec4899', color: '#fff', padding: '14px', border: 'none',
              borderRadius: '12px', fontSize: '1rem', fontWeight: 'bold', cursor: 'pointer',
              boxShadow: '0 4px 15px rgba(236, 72, 153, 0.3)', transition: 'transform 0.2s'
            }}
      ...
      {/* Animación del fondo y placeholder */}
      <style>{`
        ...
        input:focus { background: rgba(255, 255, 255, 0.7) !important; border: 1px solid #ec4899 !important; }
      `}</style>
    </div>
  );
};